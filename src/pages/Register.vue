  ...
  <q-page padding>
    <q-form class="row justify-center" @submit.prevent="handleRegister">
      ...
      <div class="col-md-4 col-sm-6 col-xs-10 q-gutter-y-md">
        ...
        <q-input outlined label="Nome" v-model="form.name" lazy-rules
          :rules="[(val) => (val && val.length > 0) || 'Informe o Nome']" />

        <q-input outlined label="Email" v-model="form.email" lazy-rules :rules="[
          val => !!val || 'Email é obrigatório',
          val => /.+@.+\..+/.test(val) || 'Email inválido'
        ]" />

        <q-input outlined label="Senha de Acesso" v-model="form.password" lazy-rules :rules="[
        ...
        <div class="row q-col-gutter-md">
          <div class="col">
            <q-btn :label="isUpdate ? 'Cadastro de Conta' : 'Cadastro de Conta'" color="primary" class="full-width"
              rounded type="submit" />
          </div>
          <div class="col">
